    ...
    <main className=" w-full h-full md:mb-[200px]">
      ...
      <div className="md:pt-[80px] pt-[80px] px-4 md:px-0">
        <div className=" w-full h-full md:grid md:grid-cols-2 md:gap-10 overflow-hidden">
          ...
          <p className="font-EuclidCircularA font-regular lg:w-[469px] mt-[25px] md:h-[80px] md:mt-[103px] md:mr-[5px] break-words leading-[20.29px] text-[#54555B] text-[16px]">
        ...
        <div className="w-full h-full md:grid md:grid-cols-2 md:gap-4">
          ...
          <div className="md:mt-[120px]">
            <h1 className="text-[#2F3035] text-[24px] mt-[20px] md:mt-0 font-EuclidCircularA font-semibold md:text-[48px] md:leading-[60.86px] md:w-[236px] md:h-[61px]">
              Our Vision
            </h1>
            <p className="font-EuclidCircularA font-regular  lg:w-[469px] md:h-[80px] md:mr-[5px] break-words leading-[20.29px] text-[#85868D] text-[16px]">
